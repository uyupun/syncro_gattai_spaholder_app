...
class ArmLayoutConfig {
  // 上腕
  final Vector2 upperArmPosition;
  final Vector2 upperArmSize;

  // 前腕
  final Vector2 foreArmPosition;
  final Vector2 foreArmSize;

  // 肩
  final Vector2 shoulderPosition;
  final Vector2 shoulderSize;

  // ジョイント
  final Vector2 shoulderAnchorA;
  final Vector2 shoulderAnchorB;
  final Vector2 elbowAnchorA;
  final Vector2 elbowAnchorB;
  ...
  factory ArmLayoutConfig.fromJson(Map<String, dynamic> json) {
    ...
    return ArmLayoutConfig(
      ...
      shoulderAnchorA: _parseVector2(
        shoulderJoint?['anchorA'] as Map<String, dynamic>?,
      ),
      shoulderAnchorB: _parseVector2(
        shoulderJoint?['anchorB'] as Map<String, dynamic>?,
      ),
      elbowAnchorA: _parseVector2(
        elbowJoint?['anchorA'] as Map<String, dynamic>?,
      ),
      elbowAnchorB: _parseVector2(
        elbowJoint?['anchorB'] as Map<String, dynamic>?,
      ),
  ...
  static Future<ArmLayoutConfig> loadFromAsset() async {
    try {
      ...
      return ArmLayoutConfig.fromJson(
